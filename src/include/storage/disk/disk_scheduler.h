...
class DiskScheduler {
 public:
  ...
  /**
   * @brief Create a Promise object. If you want to implement your own version of promise, you can change this
   function
  ...
  auto ProcessDeal(std::optional<DiskRequest> task) -> void;
 ...
 private:
  ...
  std::vector<std::thread> th_wait_{};
};
}  // namespace bustub
