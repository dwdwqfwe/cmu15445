...
class WindowFunctionExecutor : public AbstractExecutor {
 ...
 private:
  auto MakeAggregateKey(const Tuple *tuple, std::vector<AbstractExpressionRef> &express) -> AggregateKey;
  auto MakeAggregateValue(const Tuple *tuple, AbstractExpressionRef &express) -> Value;
